...
mkdir ./lora/Salie/
mv text-generation-webui-tmp/models/Neko-Institute-of-Science_LLaMA-13B-4bit-128g/* ./models/Neko-Institute-of-Science_LLaMA-13B-4bit-128g/
mv text-generation-webui-tmp/loras/binhgiangnguyendanh_test_salie_lora/* ./lora/Salie/
