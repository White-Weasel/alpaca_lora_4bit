...
if not ft_config.skip:
    ...
    elif ft_config.ds_type == "salie" and not ft_config.skip:
        #### Salieri Data
        data = train_data.TrainSalie(ft_config.dataset, ft_config.val_set_size, tokenizer, ft_config.cutoff_len, ft_config.data_format)
    else:
